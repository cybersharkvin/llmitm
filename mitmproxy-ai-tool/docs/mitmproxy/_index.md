...
Navigate this documentation by section:

| Section | Description |
|---------|-------------|
| [Overview](overview/) | Installation, getting started, and feature overview |
| [Core Concepts](concepts/) | Filters, modes, certificates, protocols, commands, and options |
| [Addon Development](addons/) | Python scripting: event hooks, options, commands, examples |
| [API Reference](api/) | Python API for HTTP, flows, connections, TCP, WebSocket, DNS |
| [Tutorials](tutorials/) | Practical examples: client replay, traffic modification |
| [HOWTOs](howto/) | Specific guides: transparent proxy, Android CA, Wireshark TLS |
| [CLI Tutorials](cli-tutorials/) | Video tutorials for console interface |
| [Web Tutorials](web-tutorials/) | Video tutorials for browser interface |

### For LLM-Operated Workflows

Focus on:
1. **[Concepts > Filters](concepts/filters.md)** - Essential for targeting traffic
2. **[Addons > Event Hooks](addons/event-hooks.md)** - For automated analysis
3. **[API > mitmproxy.http](api/mitmproxy.http.md)** - Request/response manipulation
